...
app.use('/doc', swaggerUi.serve, swaggerUi.setup(swaggerDocument)).use(express.json()).use((req, res, next) => {
...
}).use("/pokemon", pokemonRoutes).use("/capturedPokemon", capturedPokemonRoutes);
